...
namespace AIEditorWindowTool.Core
{
    ...
    {
        private const string PrefKey = "HierarchyProject.LastFolderPath";
        ...
        private void PingAndSelect(string assetPath)
        {
        ...
        private void EnsureAllLoaded(TreeNode node)
        {
        ...
        private string BuildHierarchyString(TreeNode node, int indent = 0)
        {
